# Form implementation generated from reading ui file 'mainAccManServiceUi.ui'
#
...
class AccManService_Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setStyleSheet("QPushButton#viewSalesButton{\n"
"    background-color:#984063;\n"
"    color:rgba(255, 255, 255, 200);\n"
"    border-radius:5px;\n"
"}\n"
"QPushButton#viewSalesButton:pressed{\n"
"    padding-left:5px;\n"
"    padding-top:5px;\n"
"    background-color:#26648E;\n"
"    background-position:calc(100%-10px)center;\n"
"}\n"
"QPushButton#viewSalesButton:hover{\n"
"    background-color:#26648E;\n"
"}\n"
...
"")
        ...
        self.tableWidget.setGeometry(QtCore.QRect(766, 170, self.containerLabel.geometry().width()-775, self.containerLabel.geometry().height()-179))
        ...
        self.tableWidget.horizontalHeader().setDefaultSectionSize(268)
...
"")
        ...
        self.widget.setGeometry(QtCore.QRect(9, 170, 761, 771))
        self.widget.setObjectName("widget")
        self.analysisLabel = QtWidgets.QLabel(parent=self.widget)
        self.analysisLabel.setGeometry(QtCore.QRect(20, 15, 251, 41))
        font = QtGui.QFont()
        font.setFamily("Dubai")
        font.setPointSize(17)
        font.setBold(True)
        self.analysisLabel.setFont(font)
        self.analysisLabel.setStyleSheet("color:#26648E;")
        self.analysisLabel.setObjectName("analysisLabel")
        self.verticalLayoutWidget = QtWidgets.QWidget(parent=self.widget)
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(0, 135, 751, int(self.screen_height*0.65)))
        self.verticalLayoutWidget.setObjectName("verticalLayoutWidget")
        self.verticalLayout = QtWidgets.QVBoxLayout(self.verticalLayoutWidget)
        self.verticalLayout.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout.setObjectName("verticalLayout")
        self.horizontalLayoutWidget = QtWidgets.QWidget(parent=self.widget)
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(40, 60, 681, 80))
        ...
        self.viewSalesButton = QtWidgets.QPushButton(parent=self.centralwidget)
        self.viewSalesButton.setGeometry(QtCore.QRect(130, 125, 101, 41))
        font = QtGui.QFont()
        font.setFamily("Dubai")
        font.setPointSize(14)
        font.setBold(True)
        self.viewSalesButton.setFont(font)
        self.viewSalesButton.setStyleSheet("")
        self.viewSalesButton.setObjectName("viewSalesButton")
        self.serviceLabel = QtWidgets.QLabel(parent=self.centralwidget)
        self.serviceLabel.setGeometry(QtCore.QRect(25, 130, 111, 31))
        font = QtGui.QFont()
        font.setFamily("Dubai")
...
"")
        ...
        self.viewSalesButton.setGraphicsEffect(QtWidgets.QGraphicsDropShadowEffect(blurRadius=25,xOffset=3,yOffset=3))
    ...
    def retranslateUi(self, MainWindow):
        ...
        item.setText(_translate("MainWindow", "Amout Received"))
        self.searchLineEdit.setPlaceholderText(_translate("MainWindow", "Search ID,TestName"))
        self.logOutButton.setText(_translate("MainWindow", "Log Out"))
        self.analysisLabel.setText(_translate("MainWindow", "Analysis by Revenue"))
        ...
        self.viewSalesButton.setText(_translate("MainWindow", "View Sales"))
        self.serviceLabel.setText(_translate("MainWindow", "Services"))
