# Form implementation generated from reading ui file 'mainAdminSaleAnalysisUi.ui'
#
...
class AdminSaleAnalysis_Ui_MainWindow(object):
...
"    border-radius:5px;\n"
"}\n"
"QPushButton#viewItemsButton:pressed{\n"
"    padding-left:5px;\n"
"    padding-top:5px;\n"
"    background-color:#26648E;\n"
"    background-position:calc(100%-10px)center;\n"
"}\n"
"QPushButton#viewItemsButton:hover{\n"
"    background-color:#26648E;\n"
"}\n"
...
"")
        ...
        self.salesAnalysisLabel = QtWidgets.QLabel(parent=self.centralwidget)
        self.salesAnalysisLabel.setGeometry(QtCore.QRect(25, 130, 201, 31))
        font = QtGui.QFont()
        font.setFamily("Dubai")
        font.setPointSize(20)
        font.setBold(True)
        self.salesAnalysisLabel.setFont(font)
        self.salesAnalysisLabel.setStyleSheet("color:#41436A;")
        self.salesAnalysisLabel.setObjectName("salesAnalysisLabel")
        self.viewItemsButton = QtWidgets.QPushButton(parent=self.centralwidget)
        self.viewItemsButton.setGeometry(QtCore.QRect(210, 125, 71, 41))
        font = QtGui.QFont()
        font.setFamily("Dubai")
        font.setPointSize(14)
        font.setBold(True)
        self.viewItemsButton.setFont(font)
        self.viewItemsButton.setStyleSheet("")
        self.viewItemsButton.setObjectName("viewItemsButton")
...
"")
        ...
        self.widget.raise_()
        self.salesAnalysisLabel.raise_()
        self.viewItemsButton.raise_()
        ...
        self.viewItemsButton.setGraphicsEffect(QtWidgets.QGraphicsDropShadowEffect(blurRadius=25,xOffset=3,yOffset=3))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.categoryComboBox.setItemText(0, _translate("MainWindow", "Items"))
        self.categoryComboBox.setItemText(1, _translate("MainWindow", "In stock"))
        self.categoryComboBox.setItemText(2, _translate("MainWindow", "Sale price"))
        self.categoryComboBox.setItemText(3, _translate("MainWindow", "Purchase price"))
        self.salesAnalysisLabel.setText(_translate("MainWindow", "Sales Analysis"))
        self.viewItemsButton.setText(_translate("MainWindow", "Items"))
